package com.mortgagehotline.manager.Support;
...
public class RecyclerViewDividerItem_MultiViewHolder extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewDividerItem_MultiViewHolder(Context context, int orientation) {
    ...
    public boolean isDecorated(View view, RecyclerView parent) {
        ...
        return holder instanceof FragmentRVAdapter.CustomViewHolder;
    }
